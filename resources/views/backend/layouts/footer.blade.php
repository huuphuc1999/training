...
<script src="{{asset('backend/select/js/jquery-3.3.1.min.js')}}"></script>
<!-- jQuery -->
...
<link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.css" />
   ...
   <script src="{{asset('backend/select/js/popper.min.js')}}"></script>
   {{-- <script src="{{asset('backend/select/js/bootstrap.min.js')}}"></script> --}}
   <script src="{{asset('backend/select/js/jquery.multiselect.js')}}"></script>
   <script src="{{asset('backend/select/js/main.js')}}"></script>
@stack('scripts')
