                  ...
                  <div class="modal-dialog modal-sm">
                    <div style="width: 550px;" class="modal-content">
                      ...
                      <div class="modal-header">
                        <h4 class="modal-title" id="popupProductTitle">Thêm product</h4>
                            ...
                            <div class="form-group">
                              ...
                              <div style="width: 75%;" class="col-sm-10">
                                <input type="text" class="form-control " name="addProductName" id="addProductName"
                                  placeholder="Nhập họ tên">
                                <span id="productName-err" class="error text-danger d-none"></span>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="inputEmail3" class="col-sm-2 control-label">Giá bán</label>
                              <div style="width: 75%;" class="col-sm-10">
                                <input type="number" class="form-control " name="addProductPrice" id="addProductPrice"
                                  placeholder="Nhập giá bán">
                                <span id="productPrice-err" class="error text-danger d-none"></span>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="inputPassword3" class="col-sm-2 control-label">Mô tả</label>
                              <div style="width: 75%;" class="col-sm-10">
                                <textarea name="addProductDescription" id="addProductDescription"
                                  placeholder="Mô tả sản phẩm" style="width: 368px; height: 115px;" cols="30"
                                  rows="5"></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              ...
                              <div class="col-md-9 col-sm-9 col-xs-12">
                                <div class="file-drop-area">
                                  ...
                                  <input class="file-input" id="addProductImage" name="addProductImage" type="file"
                                    accept="image/png, image/jpg, image/jpeg">
                                </div>
                                <span id="productImage-err" class="error text-danger d-none"></span>
                              </div>
                            </div>
                            <div class="form-group">
                              ...
                              <div style="width: 75%;" class="col-sm-10">
                                ...
                                <button style="float: right" id="removeImage" type="button" class="btn btn-danger">Xóa
                                  ảnh</button>
                              </div>
                            </div>
  ...
  //   });
     ...
     */
        $('body').on('click', '#addProductButton', function (e) {
          ...
          var productDes = $("#addProductDescription").val();
